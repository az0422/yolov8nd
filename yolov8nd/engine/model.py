...
from yolov8nd.cfg import TASK2DATA, get_cfg, get_save_dir
from yolov8nd.hub.utils import HUB_WEB_ROOT
from yolov8nd.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
from yolov8nd.utils import ASSETS, DEFAULT_CFG_DICT, LOGGER, RANK, SETTINGS, callbacks, checks, emojis, yaml_load
...
class Model(nn.Module):
    ...
    def _get_hub_session(model: str):
        ...
        from yolov8nd.hub.session import HUBTrainingSession
    ...
    def predict(
        ...
        **kwargs,
        ...
        is_cli = (sys.argv[0].endswith("yolov8nd")) and any(
    ...
    def track(
        ...
        **kwargs,
        ...
        if not hasattr(self.predictor, "trackers"):
            from yolov8nd.trackers import register_tracker
    ...
    def tune(
        ...
        **kwargs,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from yolov8nd.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        """
        from yolov8nd.nn.autobackend import check_class_names
