...
from yolov8nd.hub import HUB_WEB_ROOT, PREFIX, HUBTrainingSession, events
from yolov8nd.utils import LOGGER, RANK, SETTINGS
...
def on_fit_epoch_end(trainer):
    ...
    if session:
        ...
        if trainer.epoch == 0:
            from yolov8nd.utils.torch_utils import model_info_for_loggers
