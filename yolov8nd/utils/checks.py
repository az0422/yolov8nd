...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Example:
        ```python
        from yolov8nd.utils.checks import parse_requirements
...
def check_requirements(requirements=ROOT.parent / "requirements.txt", exclude=(), install=True, cmds=""):
    ...
    Example:
        ```python
        from yolov8nd.utils.checks import check_requirements
...
def collect_system_info():
    ...
    from yolov8nd.utils import ENVIRONMENT  # scope to avoid circular import
    from yolov8nd.utils.torch_utils import get_cpu_info
...
def check_amp(model):
    ...
    Example:
        ...
        from yolov8nd.utils.checks import check_amp
    ...
    """
    from yolov8nd.utils.torch_utils import autocast
